...
const linkSuspeito =
  ...
  linkInput.includes("bit.ly") ||
  linkInput.includes("tinyurl");

if (linkSuspeito) {
  console.log(
    chalk.red(
      "⚠️ Esse link parece suspeito. Prefira acessar diretamente o site da ONG."
    )
  );
} else {
  console.log(
    chalk.green(
      "🔗 O link parece seguro, mas ainda é melhor confirmar no site oficial."
    )
  );
}
...
console.log(
  chalk.blue(
    "🌐 Evite intermediários desconhecidos e confirme sempre o endereço do site.\n"
  )
);

console.log(
  chalk.bgGreen.white.bold("✅ Fique seguro e ajude com responsabilidade!")
);
}
